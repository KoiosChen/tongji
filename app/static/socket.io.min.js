    ...
    return function (t) {
        ...
        (function (e) {
            ...
            t.exports = n, n.priorWebsocketSuccess = !1, s(n.prototype), n.protocol = u.protocol, n.Socket = n, n.Transport = r(26), n.transports = r(21), n.parser = r(27), n.prototype.createTransport = function (t) {
                ...
                if (a("socket open_gate"), this.readyState = "open", n.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.upgrade && this.transport.pause) {
                ...
                function t() {
                    n.onClose("forced close_gate"), a("socket closing - telling transport to close_gate"), n.transport.close()
                }
        ...
        (function (e) {
            ...
            t.exports = o, t.exports.Request = i, h(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function (t) {
                ...
                try {
                    p("xhr open_gate %s: %s", this.method, this.uri), r.open(this.method, this.uri, this.async);
                    try {
        ...
        a(n, o), n.prototype.name = "polling", n.prototype.doOpen = function () {
            ...
            function t() {
                u("writing close_gate packet"), e.write([{type: "close"}])
            }

            var e = this;
            "open" === this.readyState ? (u("transport open_gate - closing"), t()) : (u("transport not open_gate - deferring close_gate"), this.once("open", t))
        ...
        i(n.prototype), n.prototype.subEvents = function () {
            ...
            u("transport is open_gate - connecting"), "/" !== this.nsp && (this.query ? this.packet({
                type: o.CONNECT,
                query: this.query
